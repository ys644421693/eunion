...
(function( $ )
{
    ...
    $.extend(Wysiwyg.prototype,
    {
        ...
        init : function( element, options )
        {
            ...
            var panel = this.panel = $('<ul sysrole="menu" class="panel"></ul>');
        ...
        appendMenu : function( cmd, args, className, fn, tooltip )
        {
            ...
            $('<li></li>').append(
                $('<a sysrole="menuitem" tabindex="-1" href="javascript:;">' + (className || cmd) + '</a>')
        ...
        {
            $('<li sysrole="separator" class="separator"></li>').appendTo( this.panel );
        },
